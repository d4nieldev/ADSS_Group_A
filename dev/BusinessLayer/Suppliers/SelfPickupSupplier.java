...
class SelfPickupSupplier extends Supplier {
    ...
    public SelfPickupSupplier(int id, String name, String phone, String bankAcc, List<String> fields, String paymentCondition,
    Map<Integer, Double> amountToDiscount, Queue<Integer> reservationHistory, List<Contact> contacts, String address) {
    ...
    public SelfPickupSupplier(int id, String name, String phone, String bankAcc,List<String> fields, String paymentCondition,
    Map<Integer, Double> amountToDiscount, String addresses) {
