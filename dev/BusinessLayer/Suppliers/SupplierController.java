...
public class SupplierController {
    ...
    public Supplier getSupplierById(int supplierId) throws Exception{
        if(idToSupplier.containsKey(supplierId)){
            ...
            throw new NoMatchingSupplierException("There is no supplier with id "+supplierId+" in the system.");
        }
    }
    ...
    public void addFixedDaysSupplierBaseAgreement(String supplierName, String supplierPhone, String supplierBankAccount,
            ...
            try{
                FixedDaysSupplier fds=new FixedDaysSupplier(nextSupplierIdInSystem, supplierName, supplierPhone, supplierBankAccount,
                 supplierFields, paymentCondition, amountToDiscount, makeContactList(contactPhones, contactNames, nextSupplierIdInSystem), days);
    ...
    public void addOnOrderSupplierBaseAgreement(String supplierName, String supplierPhone,
            ...
            try{
                OnOrderSupplier oos=new OnOrderSupplier(nextSupplierIdInSystem, supplierName, supplierPhone, supplierBankAccount,
                    supplierFields, paymentCondition, amountToDiscount, makeContactList(contactPhones, contactNames, nextSupplierIdInSystem), maxSupplyDays);
    ...
    public void addSelfPickupSupplierBaseAgreement(String supplierName, String supplierPhone,
            ...
            try{
                SelfPickupSupplier spus=new SelfPickupSupplier(nextSupplierIdInSystem, supplierName, supplierPhone, supplierBankAccount,
                    supplierFields, paymentCondition, amountToDiscount, makeContactList(contactPhones, contactNames, nextSupplierIdInSystem), address);
    ...
    public void setSupplierContactNamesAndPhones(int supplierId, List<String> contactPhones, List<String> contactNames) throws Exception{
        try{
    ...
    // Makes a list of Contact objects from a list of phone numbers and list of names
