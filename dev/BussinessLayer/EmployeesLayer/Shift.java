...
public class Shift{
    ...
    public void checkAssignFinalShift_Employees(HashMap<Employee, Integer> hrAssign){
    ...
    // set the final shift
    public void checkAssignFinalShift_Roles(HashMap<Employee, Integer> hrAssign){
        for (Employee currAssignEmployee : hrAssign.keySet()) {
