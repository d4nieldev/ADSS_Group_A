...
public class ReservationDAO extends DAO<ReservationDTO> {
    ...
    public boolean insert(ReservationDTO dataObject) throws SQLException{
        ...
        PreparedStatement statement = con.prepareStatement("INSERT INTO "+this.tableName+"("+columnsString(columnNames)+") Values (?, ?, ?, ?, ?)");
    ...
    public ReservationDTO makeDTO(ResultSet RS) throws SQLException {
        ...
        res = new ReservationDTO(RS.getInt(1), RS.getInt(2), RS.getDate(3), enumHandler(RS.getString(4)), RS.getString(5));
        return res;
    }
