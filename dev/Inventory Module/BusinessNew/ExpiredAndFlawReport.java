...
public class ExpiredAndFlawReport extends Report{
    private HashMap<Integer,HashMap<Integer,LocalDate>> idToExpiredSpecificIdAndDate; //maps between productBranch to map specific and ExpireDate
    private HashMap<Integer , HashMap<Integer,String>> codeToSpecificDescription; //maps between product code to map of specificId and flaw description all its specificProducts that flaws
