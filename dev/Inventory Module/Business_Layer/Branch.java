...
public class Branch {
    ...
    HashMap<Integer, Business_Layer.ProductBranch> allProductBranches;// maps between productBranch generalId to its object
    private Business_Layer.PeriodicReservation periodicReservation;
    private Business_Layer.CategoryController categoryController;
    public Branch(int branchId, String branchName) {
        this.branchId = branchId;
        this.branchName = branchName;
        this.allProductBranches = new HashMap<>();
        this.periodicReservation = new Business_Layer.PeriodicReservation();
        this.categoryController = Business_Layer.CategoryController.getInstance();
    }
    ...
    public void addNewProductBranch(Business_Layer.Product product , double price, int idealQuantity, int minQuantity){
        Business_Layer.ProductBranch newProduct = new Business_Layer.ProductBranch( product , price,  idealQuantity, minQuantity)  ;
...
//        SpecificProduct sp4 = new SpecificProduct(generalId,20,yesterday);
        Business_Layer.ProductBranch productBranch = allProductBranches.get(generalId);
...
//    }
    public void sellProduct(int code, int specificId) throws Exception {
        Business_Layer.ProductBranch productBranch = allProductBranches.get(code);
...
//            makeDeficiencyReservation(productBranch);
    ...
    private void alertForDeficiency(Business_Layer.ProductBranch productBranch) {
