...
public class ProductControllerTest {
    ...
    public void testAddNewGeneralProduct() {
        ...
        GeneralProduct gp = new GeneralProduct(name,code,price,manufacturer,minQuanitity,category);
    ...
    public void testGetGeneralProductByCode() {
        ...
        Category category = new Category("Milk");
         gp = new GeneralProduct(name,code,price,manufacturer,minQuanitity,category);
        pc.addNewGeneralProduct(gp,totalQuantity);
    ...
    public void testReceiveNewSupply() {
        ...
        pc.receiveNewSupply(code, name, price, amount, expiredDate, manufacturer, minQuantity, categoryId, categoryName, categoryParentId);
    ...
    public void testTransferFromStorageToShopWithCategories() {
        ...
        pc.receiveNewSupply(1, "Milk", 2.5, 10, LocalDate.now().plusMonths(1), "Company A", 2, dairyCategory.getId(), null, -1);
        pc.receiveNewSupply(2, "Cheese", 4.5, 5, LocalDate.now().plusMonths(2), "Company B", 1, dairyCategory.getId(), null, -1);
        pc.receiveNewSupply(3, "Bread", 1.5, 20, LocalDate.now().plusDays(7), "Company C", 3, foodCategory.getId(), null, -1);
    ...
    public void testAlertForMinimumQuantity() {
        ...
        Category foodCategory = new Category("Food");
        pc.receiveNewSupply(3, "Bread", 1.5, 5, LocalDate.now().plusDays(7), "Company C", 2, foodCategory.getId(), null, -1);
