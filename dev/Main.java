...
class Main {
  ...
  public static void main(String[] args) {
    ...
    while (choose != -1) {
      if (choose == 1) {
        ...
        System.out.println(
          "please choose Action - press 0 for showing the menu"
        );
        System.out.println("1  - add new product");
        System.out.println("2  - import inventory report");
        System.out.println("3  - receive Supply");
  ...
  public static void addProduct() {
    ...
    System.out.println(
      "if category is sub category enter its parent category, otherwise -1"
    );
  ...
  public static void reciveSupply() {
    ...
    String manufacturer = scanner.nextLine();
    System.out.println(
      "please enter the product expired date : in format YYYY-MM-DD"
    );
    ...
    if (gp != null) {
      productService.receiveExistSupply(
        code,
        name,
        price,
        amount,
      ...
      int parentCategory = scanner.nextInt();
      scanner.skip("\n");
      productService.receiveNewtSupply(
        code,
        name,
        price,
        amount,
  ...
  public static void setDiscountByCategories() {
    ...
    while (chose != -1) {
      ...
      scanner.skip("\n");
      if (chose != -1) lst.add(chose);
    }
    System.out.println(
      "please enter the discount start date : in format YYYY-MM-DD"
    );
    String startDate = scanner.nextLine();
    System.out.println(
      "please enter the discount end date : in format YYYY-MM-DD"
    );
    String endDate = scanner.nextLine();
    System.out.println("please enter discount percentage");
    double discountPercentage = scanner.nextDouble();
    productService.setDiscountByCategories(
      lst,
  ...
  public static void setDiscountByProducts() {
    ...
    System.out.println("please enter discount percentage");
    double discountPercentage = scanner.nextDouble();
    productService.setDiscountByProducts(
      lst,
      LocalDate.parse(startDate),
      LocalDate.parse(endDate),
      discountPercentage
