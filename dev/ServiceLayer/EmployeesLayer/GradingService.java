...
public class GradingService {
    ...
    int bankBranch, int bankAccount, int salary, int InitializeBonus, LocalDate startDate, License driverLicense, String role, int branch, String status){
        branchS.addNewEmployee(managerId, firstName, lastName, id, password, bankNum, bankBranch, bankAccount, salary, InitializeBonus, startDate, driverLicense, role, branch, status);
    }
