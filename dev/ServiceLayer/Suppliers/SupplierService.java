...
public class SupplierService {
    ...
    public SupplierService() {
        ...
        productAgreementController = new ProductAgreementController();
    }

    //Add 'Fixed days' supplier
    public String addFixedDaysSupplierBaseAgreement(String supplierName, String supplierPhone, String supplierBankAccount,
            ...
            try{   
                supplierController.addFixedDaysSupplierBaseAgreement(supplierName, supplierPhone, supplierBankAccount, supplierFields,
    ...
    public String addOnOrderSupplierBaseAgreement(String supplierName, String supplierPhone, String supplierBankAccount,
            ...
            try{   
                supplierController.addOnOrderSupplierBaseAgreement(supplierName, supplierPhone, supplierBankAccount, supplierFields,
    ...
    public String addSelfPickupSupplierBaseAgreement(String supplierName, String supplierPhone, String supplierBankAccount,
            List<String> supplierFields, String paymentCondition, Map<Integer, Double> amountToDiscount,
            List<String> contactNames, List<String> contactPhones, String address) {
                try{   
                    supplierController.addSelfPickupSupplierBaseAgreement(supplierName, supplierPhone, supplierBankAccount, supplierFields,
    ...
    public String setSupplierContactNamesAndPhones(int supplierId, List<String> contactPhones, List<String> contactNames) {
        try{
