...
import BussinessLayer.TransPortLayer.*;
...
public class UnitTest {
    ...
    public void setUp() {
        ...
        truckFacade.newTrack("aaaa", "B", 200, 250);
    ...
    public void testTruck() {
        truckFacade.getTruck("aaaa").setModel("A");
        assertEquals("don't change the model of track", "A" ,truckFacade.getTruck("aaaa").getModel());
    }

    @Test
    public void testWightTruck() {
        truckFacade.getTruck("aaaa").setWeightMax(400);
        assertEquals("don't change the weight max", 400, truckFacade.getTruck("aaaa").getWeightMax());
    }

    @Test
    public void testWightNetoTruck() {
        truckFacade.getTruck("aaaa").setWeightNeto(600);
        assertEquals("don't change the weight max", 600, truckFacade.getTruck("aaaa").getWeightMax());
    }

    @Test
    public void testWightTruckTwo() {
        truckFacade.getTruck("aaaa").setWeightMax(0);
        assertEquals("don't change the weight max", 0, truckFacade.getTruck("aaaa").getWeightMax());
    }
/*
    ...
    */
    ...
    public void testChangingOrderWithInvalidInput() {
        // Create transport with a list of destinations
