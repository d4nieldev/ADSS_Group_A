...
class EmployeeControllerTest {
    ...
    void addEmployee() {
        ...
        assertThrows(Error.class, () -> emp.addEmployee(123456789,"Tal", "Koren", 123, "123",
                123, 123, 123, 123, 123,
                localDate, License.B, "Chashier", 0, "Student")); //add employee from offline HR.

        //////////////Test 2///////////////
        emp.logIn(123456789, "abc");
        emp.addEmployee(123456789,"Tal", "Koren", 123, "123",
                123, 123, 123, 123, 123,
                localDate, License.B, "Chashier", 0, "Student");

        assertThrows(Error.class, () -> emp.addEmployee(123456789,"Inbar", "Chaim", 123, "123",
                123, 123, 123, 123, 123,
                localDate, License.B, "Chashier", 0, "Student")); //add employee with id that already exist in the system.

        //////////////Test 3///////////////
        assertThrows(Error.class, () -> emp.addEmployee(123,"Inbar", "Chaim", 123456, "123",
                123, 123, 123, 123, 123,
                localDate, License.B, "Chashier", 0, "Student")); //add employee from non HR employee.
    ...
    void addRoleToEmployee() {
        ...
        //////////////Test 1///////////////
        emp.addRoleToEmployee(123456789,123,"Driver");
        Employee e1 = emp.getEmployeeById(123);
        assertTrue(e1.getRoles().contains("Driver")); //check if the function works.

        //////////////Test 2///////////////
        emp.logOut(123456789);
        assertThrows(Error.class, () -> emp.addRoleToEmployee(123456789,123,"Driver")); //add role from logged out employee.

        //////////////Test 3///////////////
        emp.logIn(123, "123");
        assertThrows(Error.class, () -> emp.addRoleToEmployee(123,123,"Driver")); //add role from non HR manager employee.

        //////////////Test 4///////////////
        emp.logIn(123456789, "abc");
        assertThrows(Error.class, () -> emp.addRoleToEmployee(123456789,12345,"Driver")); //add role to not exist employee.

        //////////////Test 5///////////////
        assertThrows(Error.class, () -> emp.addRoleToEmployee(123456789,123,"Driver")); //try to add role that already exist in that employee.
    ...
    void removeRoleFromEmployee() {
        ...
        //////////////Test 1///////////////
        emp.addRoleToEmployee(123456789,123,"Driver");
        emp.removeRoleFromEmployee(123456789, 123, "Driver");
        Employee e1 = emp.getEmployeeById(123);
        ...
        emp.addRoleToEmployee(123456789,123,"Driver");
        emp.removeRoleFromEmployee(123456789, 123, "Driver");
        assertThrows(Error.class, () -> emp.removeRoleFromEmployee(123456789,123,"Driver")); //try to remove role that the employee do not have.

        //////////////Test 3///////////////
        emp.logOut(123456789);
        assertThrows(Error.class, () -> emp.removeRoleFromEmployee(123456789,123,"Driver")); //try to remove role from logged out employee.

        //////////////Test 4///////////////
        emp.logIn(123, "123");
        assertThrows(Error.class, () -> emp.removeRoleFromEmployee(123,123,"Driver")); //non HR employee try to remove role.

        //////////////Test 5///////////////
        emp.logIn(123456789,"abc");
        assertThrows(Error.class, () -> emp.removeRoleFromEmployee(123456789,12345,"Driver")); //try to remove role from non exist employee.
    }
